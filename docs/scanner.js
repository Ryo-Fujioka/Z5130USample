...
// デバイスインスタンスパス
const VENDOR_ID = 0x24EA;
const PRODUCT_ID = 0x0187;

const CMD_START_SCAN = "\x1B\x41\x30\x0D"; // <ESC>A0<CR> 読み取り開始コマンド(LED点灯)
const CMD_STOP_SCAN = "\x1B\x41\x31\x0D";  // <ESC>A1<CR>  読み取り終了コマンド(LED消灯)
const BAUD_RATE = 9600;                    // ビットレート
